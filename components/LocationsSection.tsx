...
export default function LocationsSection() {
  ...
  const content = {
    en: {
      ...
      time1: "Thursday: 1:00 PM – 3:00 PM",
      phone1: "+20 155 578 3179",
      tag2: "Private Hospital",
      title2: "Andalusia Hospitals",
      address2: "Maadi Branch, Cairo",
      time2: "Monday & Wednesday: 5:00 PM – 6:00 PM",
      phone2: "16781",
    },
    ar: {
      ...
      time1: "الخميس: 1:00 ظهراً – 3:00 عصراً",
      phone1: "+20 155 578 3179",
      tag2: "مستشفى خاص",
      title2: "مستشفيات أندلسية",
      address2: "فرع المعادي، القاهرة",
      time2: "الإثنين والأربعاء: 5:00 مساءً – 6:00 مساءً",
      phone2: "16781",
    }
  };
