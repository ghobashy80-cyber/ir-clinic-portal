...
export default function Home() {
  ...
  const content = {
    en: {
      ...
      desc: "Led by Dr. Mohamed El Ghobashy — Associate Professor at Cairo University and Clinical Lead at Andalusia Group. Delivering state-of-the-art, image-guided treatments with rapid recovery times.",
    ...
    ar: {
      ...
      desc: "بقيادة د. محمد الغباشي — أستاذ مساعد بجامعة القاهرة والمدير الإكلينيكي للأشعة بمجموعة أندلسية. نقدم أحدث العلاجات الدقيقة الموجّهة بالأشعة مع فترات تعافٍ سريعة.",
